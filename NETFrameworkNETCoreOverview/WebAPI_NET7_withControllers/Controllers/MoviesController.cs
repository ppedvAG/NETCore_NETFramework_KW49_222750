...
namespace WebAPI_NET7_withControllers.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MoviesController : ControllerBase
    {
        private readonly WebAPI_NET7_withControllersContext _context;

        public MoviesController(WebAPI_NET7_withControllersContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Movies>> PostMovies(Movies movies)
        {
          if (_context.Movies == null)
          {
              return Problem("Entity set 'WebAPI_NET7_withControllersContext.Movies'  is null.");
          }
